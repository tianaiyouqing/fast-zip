...
import static cloud.tianai.zip.ZipConstants64.*;
import static cloud.tianai.zip.ZipUtils.fileTimeToUnixTime;
import static cloud.tianai.zip.ZipUtils.get16;
 ...
 * @Description zip打包优化用于支持 ZipEntry.STORED
 * 只能用于归并打包，不能用于压缩，压缩需要使用默认压缩工具
 */
public class ZipOutputStream extends FilterOutputStream implements ZipConstants {
    ...
    public void putNextEntry(ZipEntry e) throws IOException {
        ...
        // immediately following the compressed entry datass
        e.method = STORED;
        e.flag = 8;
        e.size = 0;
        e.csize = 0;
